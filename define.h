...
///AMR PARAMETERS
#define AMR_ON 1        //Self-explanatory. 0 means static mesh of NCELLS, and 1 means Adaptive mesh with an initial set of NCELLS
#define NCELLS  52000   //Initial number of cells (at INI_REF, important!)
#define MAX_REF 9       //Maximum level of refinement
